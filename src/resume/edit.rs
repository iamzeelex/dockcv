...
mod tests {
    ...
    fn every_addressable_field_is_drawn_by_some_view() {
        const VIEWS: &[&str] = &[
            include_str!("../views/root_sidebar.rs"),
            include_str!("../views/root_custom_sections.rs"),
            include_str!("../views/root_section_variants.rs"),
            include_str!("../views/root_section_rename.rs"),
            include_str!("../views/preset_matrix.rs"),
            include_str!("../views/root.rs"),
            include_str!("../views/shell.rs"),
        ];
