...
//! `version_draft.rs`; what a change *is* is in `version_changes.rs`.
//!
...
use super::version_changes::{Change, ChangeKind};
use super::version_draft::{section_label, selected};

impl Shell {
    /// The whole screen.
    pub(super) fn render_version_draft(&self, cx: &mut Context<Self>) -> Div {
