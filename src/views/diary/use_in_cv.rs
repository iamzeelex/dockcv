...
impl Shell {
    ...
    pub(crate) fn close_diary_use(&mut self, cx: &mut Context<Self>) {
        self.diary_use = None;
        cx.notify();
    }
    ...
    pub(crate) fn render_diary_use_sheet(
        &self,
        cx: &mut Context<Self>,
