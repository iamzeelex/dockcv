...
pub(crate) fn available(doc: &ResumeDoc, source: usize) -> Vec<Change> {
...
pub(crate) fn applied_count(changes: &[Change]) -> usize {
...
pub(crate) fn toggle(doc: &mut ResumeDoc, source: &Preset, change: &Change) {
