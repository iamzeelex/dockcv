...
impl UsageIndex {
    ...
    pub(crate) fn count_for(&self, library: &Library, section: SectionKind, index: usize) -> usize {
    ...
    pub(crate) fn total_reuses(&self, library: &Library) -> usize {
        let mut total = 0;
        for (section, len) in [
