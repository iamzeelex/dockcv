...
use super::unplaced::AdoptHandler;
...
/// that floated over the pane; `import.rs` is the pane now, and a panel
...
pub fn render_step2_review_split<V: 'static>(
    ...
    div()
        // No width, no frame, no shadow: `import.rs` owns the panel, and
        ...
        .child(
            div()
                ...
                .children(super::unplaced::render_unplaced(
                    cx,
                    imported,
                    name_field,
                    on_adopt.clone(),
