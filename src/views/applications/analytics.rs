...
//! [`super::funnel`], which is pure and tested; this file is
//! drawing only.
//!
...
use super::data::{plural, status_title};
use super::funnel::{journey, missing_history, stage_flow, JourneyNode, Period};
use super::funnel::{Funnel, Outcome};
...
impl Shell {
    pub(crate) fn render_applications_insights(
        &self,
        cx: &mut Context<Self>,
