...
fn page_setup_into(out: &mut String, layout: &LayoutSettings, language: DocumentLanguage) {
    use std::fmt::Write;
...
#set text(font: "{font}", size: {size}pt, fill: rgb("#1a1a1a"), lang: "{lang}")
...
fn resume_to_dict_into(s: &mut String, r: &Resume, dates: DateFormat, language: DocumentLanguage) {
    s.push_str("(\n");
